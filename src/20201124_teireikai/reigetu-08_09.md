...
## 予算現額推移
補正予算を受け、一般会計予算現額が8月に約16億円、9月に約18億円増えています。
9月にはその他特別会計の分も増えています。
...
<script type="text/javascript">
  ...
  function drawChart() {
    ...
    data.addRows([
      ...
      ["R2\n9月", 47.44, 29.01, 20.59, 16.07, 11.37, 6.502, 3.469, 4.016, 1.043, 0.8845, 0.6044, 0.6996, 0.5281, 0.3724, 0.3279, 0.2235, 0.04801, 0],
    ]);
    var options = {
      fontName: "UD デジタル 教科書体 N-R",
      fontSize: 14,
