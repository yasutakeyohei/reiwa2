...
{{description:令和2年7月小平市の現金出納検査結果です。基金残高の推移などを、グラフで分かりやすく表示しています。}}

# 例月現金出納検査（令和2年7月）

{{#include ../partials/yasutake-speak.md:1}} 令和2年7月分の現金収支、現金保管の状況についての検査結果報告です。いずれも誤りがないとの結論でした。7月末時点の検査結果を過去のデータも含めてグラフにしました。保管金と基金については金額順に並べました。
