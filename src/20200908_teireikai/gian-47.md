...
<br>
<table class="qanda"><tr><td><i class="fa fa-question-circle-o" aria-label="その他 議員による質問"></i></td><td>
電算関係で、国外転出者のマイナンバーカード使用を可能にするという説明があったが、これは何か。
</td></tr></table>
...
<br>
<table class="qanda"><tr><td><i class="fa fa-question-circle-o" aria-label="その他 議員による質問"></i></td><td>
地方公共団体情報システム機構負担金の交付金上限額の増とは。
</td></tr></table>

> 今年度、マイナンバー関係の電子証明書手続きが急増し、また、今後電子証明書利用の増加も見込まれることから、地方公共団体情報システム機構のシステム性能を増強するため市が（全額国庫財源で）負担するもの。
