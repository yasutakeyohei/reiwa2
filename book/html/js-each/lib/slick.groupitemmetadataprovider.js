(function ($) {
  ...
  function GroupItemMetadataProvider(inputOptions) {
    ...
    function handleGridClick(e, args) {
      ...
      // トグルボタン以外の、グループタイトル行のどこをクリックしてもトグルするように変更
      if (item && item instanceof Slick.Group && ($target.hasClass(options.toggleCssClass) || $target.parent().hasClass(options.groupCssClass))) {
